export const questions = [
  ...
  },
  {
    ...
    definition: {
      fr: '<b>Non</b>, scanR n\'est pas exhaustif dans ses repérages. scanR peut comporter des erreurs et des omissions (voir FAQ "Peut-il y avoir des erreurs dans scanR ?") et ne traite que des sources ouvertes et réutilisables.',
      en: '<b>No</b>, scanR is not exhaustive in its tracking. scanR may contain errors and omissions (see FAQ "Can there be errors in scanR?") and only deals with open and reusable sources.',
    },
  },
  {
    key: "q4",
  ...
  },
  {
    ...
    definition: {
      fr: "Trois principaux facteurs d'erreurs, d'imprécision et d'omission influencent la qualité des données de scanR : la qualité des traitements réalisés par scanR, celle des sources et celles des référentiels qui décrivent les 'objets' présentés dans scanR (entités, auteurs, projets, productions). Même si scanR s'attache en permanence à adapter ses méthodes et outils pour limiter ses erreurs internes, palier des difficultés nouvellement identifiées, des erreurs de codage, des particularités non identifiées peuvent entraîner des erreurs ou des omissions dans les données restituées. Mais les erreurs de scanR peuvent provenir de deux autres origines, indépendantes des travaux de traitement de l'information réalisés par scanR : (1) la qualité des sources : rares sont les sources mobilisées par scanR qui intègrent systématiquement un identifiant interopérable. Quand c'est le cas, elles peuvent, elles aussi, comporter des erreurs et des omissions. Au-delà de la présence insuffisante des identifiants, l'information portée par certains enregistrements des sources peut être très imprécise, incomplète, ambigüe ou tronquée ;(2) la qualité des référentiels : les référentiels sont également porteurs d'erreurs, d'imprécisions, d'omissions. Des objets peuvent en être absents. Les chaînes de caractères relatives au nommage des objets (entités, auteurs, projets, publications, brevets) peuvent être incomplètes, ambigües, tronquées, erronées. L'historique des objets dans les référentiels peut n'être que partiellement renseigné. Les référentiels peuvent évoluer avec retard par rapport à la réalité dont ils doivent rendre compte.",
  ...
  },
  {
    ...
    definition: {
      fr: "En réponse à une requête d'un utilisateur, scanR propose pour chaque type d'objets une liste ordonnée de résultats. A données identiques, cette liste est identique et indépendante du nombre de fois où cette requête est jouée. Elle est également indépendante des actions des utilisateurs à partir des résultats de cette requête. Cette liste n'est ainsi pas liée aux actions des utilisateurs. La liste des résultats est ordonnée, par défaut, par pertinence. C'est ainsi la fréquence d'apparition des termes de la requête pondérée par le type de document dans lesquels ils figurent qui détermine l'ordre d'apparition des résultats. Les champs utilisés (classées par ordre d'importance décroissant) pour ordonner les résultats d'une requête sont propres à chaque type d' 'objets' de scanR: - structures: identifiants, acronyme, noms, description, titres résumés et domaines des publications, titres des projets, acronyme des projets, titres des brevets, nom des accreditations, noms des prix, contenu du site web - auteurs: identifiants, nom complet, titres résumés et domaines des publications, domaines, affiliations récentes, noms des prix - financements: identifiant, nom, acronyme, description, domaines, nom de l'appel à projet, identifiant de l'appel à projet, nom de l'outil de financement, mots-clés, identifiants des publications, titres des publications, nom et identifiant des auteurs de publications, domaines des publications, noms acronymes et identifiants des participants - publications: identifiants, titre, identifiants des auteurs, résumé, domaines, titre du journal, nom de l'éditeur, issn du journal, identifiants des affiliations, noms des affiliations, mentions de logiciel, contextes de mentions de logiciel, identifiants des financements, noms des financements, acronymes des financements - brevets: identifiants, codes des domaines cpc, titre, descriptions, domaines cpc",
  ...
  },
  {
    ...
    definition: {
      fr: "En contradiction avec les termes de la loi n° 2016-1321 of 7 octobre 2016 Pour une République numérique, toutes les données sur les financements publics de la recherche sur appel à projet ne sont pas accessibles. scanR valorise et intègre toutes les données auxquelles il accède. Dans certains cas, l'information est accessible via des bases de données ou des API mises à disposition par le producteur de la donnée. Dans d'autres cas, scanR ne dispose que de l'information diffusée de manière ouverte sur le site web de l'institution en charge du financement. Si les résultats d'une agence de financement n'y figure pas c'est que scanR n'a pas identifié la source ouverte associée ou n'accède pas à ces données ou que, compte tenu de la qualité de l'information disponible, le coût de traitement de l'information accessible est trop élevé.",
  ...
  },
  {
    ...
    definition: {
      ...
      en: 'scanR does not have an author record in your name while you are publishing? Tell us your name, your Idref and the list of DOIs of your work and we will add an author profile to your name! <aContact> Go to the "Contact page"</aContact>  !',
    },
  },
  {
    key: "q29",
  ...
  },
  {
    ...
    definition: {
      fr: "Via différentes sources (iLab, universités et établissement d'enseignement supérieur et de recherche ou d'organismes, veille, ...), scanR identifie certaines entreprises créées par les personnels d'un laboratoire ou utilisant les connaissances et technologies qui y sont développées. Ce repérage n'est pas exhaustif et s'améliorera grâce à vos retours et signalements ! <aContact> Contactez nous</aContact>  !",
      en: "Via different sources (iLab, universities and higher education and research institutions or organizations, monitoring,...), scanR identifies certain companies created by laboratory staff or using the knowledge and technologies developed in a laboratory. This tracking is not exhaustive and will improve thanks to your feedback and reports! <aContact> Contact us</aContact>  !",
    },
  },
  {
    key: "q31",
  ...
  },
  {
    ...
    definition: {
      fr: "Les réseaux sont construits à partir des publications de recherche de SCANR. <ul><li> SCANR recherche toutes les publications liées à une requête spécifique de l'utilisateur.</li> <li> <h2>Agrégation des publications</h2><br></br> Les publications obtenues sont agrégées en fonction du modèle de réseau :  <ul><li> <h3>Modèle 'Auteurs' </h3> Les nœuds représentent les auteurs, et les arêtes indiquent le nombre de co-publications entre deux auteurs.</li> <li> <h3>Modèle 'Etablissement' </h3> Les nœuds représentent les établissements, et les arêtes représentent le nombre de co-publications entre deux établissements. </li><li> <h3>Modèle 'Laboratoires' </h3> Les nœuds représentent les laboratoires, et les arêtes indiquent le nombre de co-publications entre deux laboratoires. </li> <li> <h3>Modèle 'Thématiques' </h3> Les nœuds représentent les thématiques, et les arêtes indiquent le nombre de co-publications entre deux thématiques.</li> <li> <h3>Modèle 'Logiciels' </h3> Les nœuds représentent les logiciels, et les arêtes représentent le nombre de co-publications entre deux logiciels.</li></ul></li><li> <h2>Filtrage des données</h2> <br></br> Pour assurer la pertinence du réseau, SCANR filtre les nœuds pour ne conserver que les plus pertinents, limitant un réseau aux 300 nœuds les plus importants et / ou aux 5 composantes principales au maximum. </li></ul>",
      en: "The networks are built from research publications from SCANR. <ul><li> SCANR searches for all publications related to a specific user query.</li> <li> <h2>Aggregation of Publications</h2><br></br> The obtained publications are aggregated according to the network model: <ul><li> <h3>'Authors' Model</h3> Nodes represent authors, and edges indicate the number of co-publications between two authors.</li> <li> <h3>'Institutions' Model</h3> Nodes represent institutions, and edges represent the number of co-publications between two institutions.</li><li> <h3>'Laboratories' Model</h3> Nodes represent laboratories, and edges indicate the number of co-publications between two laboratories.</li> <li> <h3>'Themes' Model</h3> Nodes represent themes, and edges indicate the number of co-publications between two themes.</li> <li> <h3>'Software' Model</h3> Nodes represent software, and edges represent the number of co-publications between two software.</li></ul></li><li> <h2>Data Filtering</h2> <br></br> To ensure the relevance of the network, SCANR filters the nodes to keep only the most relevant ones, limiting a network to the top 300 most important nodes and/or up to 5 main components at maximum. </li></ul>",
    },
  },
  {
    key: "q59",
  ...
  },
  {
    ...
    definition: {
      fr: "<aVos>VosViewer </aVos> est un logiciel développé par CWTS (Université de Leiden), spécialisé dans la visualisation et l'analyse de réseaux, particulièrement utilisé dans le domaine de la recherche scientifique.<br></br> Nous utilisons cet outil pour visualiser les réseaux de manière interactive, offrant ainsi une compréhension approfondie des structures et des tendances au sein de vastes ensembles de données bibliographiques.",
      en: "<aVos>VOSviewer</aVos> is a software developed by CWTS (Leiden University), specialising in the visualisation and analysis of networks, particularly used in the field of scientific research. We use this tool to visualise networks interactively, providing a thorough understanding of structures and trends within large bibliographic datasets.",
    },
  },
];
