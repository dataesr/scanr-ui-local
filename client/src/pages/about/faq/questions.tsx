export const questions = [
  {
    ...
    formatting: { strong: (chunks) => <strong>{chunks}</strong> }
  },
  {
    key: "q2",
    groupkey: "general",
  ...
  },
  {
    ...
    definition: {
      fr: "<strong>Non</strong>, scanR n'est pas exhaustif dans ses repérages. scanR peut comporter des erreurs et des omissions (voir FAQ \"Peut-il y avoir des erreurs dans scanR ?\") et ne traite que des sources ouvertes et réutilisables.",
      en: "<strong>No</strong>, scanR is not exhaustive in its tracking. scanR may contain errors and omissions (see FAQ \"Can there be errors in scanR?\") and only deals with open and reusable sources."
    },
    formatting: { strong: (chunks) => <strong>{chunks}</strong> }
  },
  {
    ...
    definition: {
      fr: "scanR s'intéresse à 4 types d'\"Objets\" principaux : les <strong>entités</strong>, les <strong>projets</strong>, les <strong>auteurs</strong> et les <strong>productions</strong> (publications, thèses et brevets).\nParmi les \"entités\", scanR couvre l'ensemble des structures de recherche référencées dans le Répertoire national des structures de recherche (RNSR) ainsi que leur tutelle. Il couvre également, de la manière la plus complète possible, l'ensemble des institutions publiques ou privées, avec ou sans but lucratif mentionnées dans les principales sources mobilisées.\nscanR couvre un ensemble de \"Projets\" qui correspondent à des travaux de recherche qui ont fait l'objet d'un financement public français ou non dans la mesure où une source ouverte et réutilisable existe (voir FAQ \"Quels sont les financements recensés dans scanR ?\").\nscanR couvre les auteurs disposant d'un identifiant Idref (voir FAQ \"Quels auteurs  disposent d'un profil-auteur dans scanR ?\") pour lesquels au moins un lien vers une autre source (RNSR, production, projet) a pu être établi. Pour éviter les erreurs, scanR exclut les auteurs homonymes. Sur demande et en disposant d'informations complémentaires, scanR pourra les introduire individuellement.\nscanR couvre les publications (voir FAQ \"Quels est le périmètre des publications de recherche (articles, thèses, monographies) présenté dans scanR ?\") depuis 2013, une sélection d'ouvrages et de monographies, les thèses depuis 1990, les brevets depuis 2013.",
      en: "scanR focuses on 4 main types of \"Objects\": <strong>entities</strong>, <strong>projects</strong>, <strong>persons</strong> and <strong>productions</strong> (publications, PhD thesis and patents).\nAmong the \"entities\", scanR covers all the research structures referenced in the National Directory of Research Structures (RNSR) as well as their institutions. It also covers, in the most comprehensive way possible, all public or private institutions, whether profit-making or not, mentioned in the main sources mobilized.\nscanR covers a set of \"Projects\" that correspond to research works that have been the subject of French public funding or not insofar as an open and reusable source exists (see FAQ \"What are the funding identified in scanR?\").\nscanR covers authors with an Idref identifier (see FAQ \"Which authors have an author profile in scanR?\") for whom at least one link to another source (RNSR, production, project) could be established. To avoid errors, scanR excludes homonymous authors. On request and with additional information, scanR can introduce them individually.\nscanR covers publications (see FAQ \"What is the scope of research publications (articles, theses, monographs) presented in scanR?\") since 2013, a selection of books and monographs, theses since 1990, patents since 2013."
    },
    formatting: { strong: (chunks) => <strong>{chunks}</strong> }
  },
  {
  ...
  },
  {
    ...
    definition: {
      fr: "*scanR ne garantit pas l'exhaustivité de ses repérages*. En conséquence, les différents dénombrements proposés au fil des pages de l'application ne donnent des indications que sur le volume détecté par scanR. Même si ces dénombrements peuvent se rapprocher de l'exhaustivité, scanR ne garantit pas et ne garantira jamais l'exhaustivité de la couverture.",
      en: "*scanR does not guarantee the comprehensiveness of its tracking. Consequently, the different counts offered over the pages of the application only give indications of the volume detected by scanR. Although these counts may be close to completeness, scanR does not and will never guarantee completeness of coverage."
    }
  },
  {
    key: "q7",
  ...
  },
  {
    ...
    definition: {
      fr: "Trois principaux facteurs d'erreurs, d'imprécision et d'omission influencent la qualité des données de scanR : la qualité des traitements réalisés par scanR, celle des sources et celles des référentiels qui décrivent les \"objets\" présentés dans scanR  (entités, auteurs, projets, productions).\nMême si scanR s'attache en permanence à adapter ses méthodes et outils pour limiter ses erreurs internes, palier des difficultés nouvellement identifiées, des erreurs de codage, des particularités non identifiées peuvent entraîner des erreurs ou des omissions dans les données restituées.\nMais les erreurs de scanR peuvent provenir de deux autres origines, indépendantes des travaux de traitement de l'information réalisés par scanR : \n(1) la qualité des sources : rares sont les sources mobilisées par scanR qui intègrent systématiquement un identifiant interopérable. Quand c'est le cas, elles peuvent, elles aussi, comporter des erreurs et des omissions. Au-delà de la présence insuffisante des identifiants, l'information portée par certains enregistrements des sources peut être très imprécise, incomplète, ambigüe ou tronquée ;\n(2) la qualité des référentiels.  les référentiels sont également porteurs d'erreurs, d'imprécisions, d'omissions. Des objets peuvent en être absents. Les chaînes de caractères relatives au nommage des objets (entités, auteurs, projets, productions) peuvent être incomplètes, ambigües, tronquées, erronnées. L'historique des objets dans les référentiels peut n'être que partiellement renseigné. Les référentiels peuvent évoluer avec retard par rapport à la réalité dont ils doivent rendre compte.",
      en: "Three main factors of errors, inaccuracies and omissions influence the quality of scanR data: the quality of the processing performed by scanR, the quality of the sources and the quality of the repositories that describe the \"objects\" presented in scanR (entities, persons, projects, productions).\nEven if scanR constantly adapts its methods and tools to limit its internal errors, newly identified difficulties, coding errors, unidentified features can lead to errors or omissions in the returned data.\nBut scanR errors can come from two other sources, independent of the information processing work performed by scanR: \n(1) Source quality: few sources mobilized by scanR systematically integrate an interoperable identifier. When this is the case, they may also contain errors and omissions. Beyond the insufficient presence of identifiers, the information provided by some source records can be very imprecise, incomplete, ambiguous or truncated;\n(2) the quality of the repositories. the repositories also contain errors, inaccuracies and omissions. Objects may be missing. Strings relating to the naming of objects (entities, persons, projects, productions) may be incomplete, ambiguous, truncated, erroneous. The history of objects in repositories may only be partially filled in. Repositories can evolve with delay in relation to the reality they must report on."
    }
  },
  {
    key: "q11",
    ...
    definition: {
      fr: "scanR utilise le moteur de recherche <a href='https://www.elastic.co/' target='_blank'>Elasticsearch</a>. Il est possible à l'utilisateur de construire une requête complexe pour générer des résultats plus adaptés à une question spécifique.\nLes opérateurs disponibles sont le \"+\" (et), le \"-\" (négation) et le \"|\" (ou). Par exemple, pour faire une recherche bilingue sur le changement climatique, la requête (changement+climatique) | (climate+change) pourra être utilisée. Concernant la négation, le \"-\" doit être placé directement avant le mot interdit, sans espace.",
      en: "scanR uses the <a href='https://www.elastic.co/' target='_blank'>Elasticsearch</a> search engine. It is possible for the user to build a complex query to generate results that are more relevant to a specific question.\nThe available operators are \"+\" (and), \"-\" ( negation) and \"|\" (or). For example, to do a bilingual research on climate change, the query (changement+climatique) | (climate+change) could be used. Concerning the negation, the \"-\" must be placed directly before the forbidden word, without space."
    }
  },
  {
    key: "q12",
    ...
    definition: {
      fr: "En réponse à une requête d'un utilisateur, scanR propose pour chaque type d'objets une liste ordonnée de résultats. A données identiques, cette liste est identique et indépendante du nombre de fois où cette requête est jouée. Elle est également indépendante des actions des utilisateurs à partir des résultats de cette requête. Cette liste n'est ainsi pas liée aux actions des utilisateurs. La liste des résultats est ordonnée, par défaut, par pertinence. C'est ainsi la fréquence d'apparition des termes de la requête pondérée par le type de document dans lesquels ils figurent qui détermine l'ordre d'apparition des résultats. Suivant les objets, les résultats peuvent aussi être triés par récence ou par ordre alphabétique quand c'est pertinent.\nLes champs (et leur pondération) utilisés pour ordonner les résultats d'une requête sont propres à chaque type d' \"objets\" de scanR (entités, auteurs, financement, production). Le tableau suivant présente, pour chacun d'eux, leur méthode de pondération. <h3>Index des entités</h3> <table class=\"tg\">\n  <tr>\n    <th class=\"tg-0lax\">Champ</th>\n    <th class=\"tg-0lax\">Poids</th>\n  </tr>\n  <tr>\n    <td>Acronyme</td>\n    <td>10</td>\n  </tr>\n  <tr>\n    <td>Identifiant principal</td>\n    <td>5</td>\n  </tr>\n  <tr>\n    <td>Nom de l'entité</td>\n    <td>5</td>\n  </tr>\n  <tr>\n    <td>Identifiant de production liée</td>\n    <td>5</td>\n  </tr>\n  <tr>\n    <td>Identifiant de projet lié</td>\n    <td>5</td>\n  </tr>\n  <tr>\n    <td>Identifiant de personne de l'équipe dirigeante</td>\n    <td>5</td>\n  </tr> \n  <tr>\n    <td>Autres identifiants de l'entité</td>\n    <td>5</td>\n  </tr> \n  <tr>\n    <td>Mot-clés</td>\n    <td>3</td>\n  </tr> \n  <tr>\n    <td>Alias</td>\n    <td>2</td>\n  </tr> \n  <tr>\n    <td>Badge</td>\n    <td>2</td>\n  </tr> \n  <tr>\n    <td>Description</td>\n    <td>2</td>\n  </tr> \n  <tr>\n    <td>Titre des projets liés</td>\n    <td>1</td>\n  </tr> \n  <tr>\n    <td>Description de projets liés</td>\n    <td>1</td>\n  </tr> \n  <tr>\n    <td>Acronyme de projets liés</td>\n    <td>1</td>\n</tr>\n  <tr>\n    <td>Nom d'auteur affilié</td>\n    <td>1</td>\n  </tr>\n  <tr>\n    <td>Titre de production</td>\n    <td>1</td>\n  </tr>\n  <tr>\n    <td>Sous-titre de production</td>\n    <td>1</td>\n  </tr>\n  <tr>\n    <td>Résumé de production</td>\n    <td>1</td>\n  </tr>\n  <tr>\n    <td>Conteu du site web</td>\n    <td>1</td>\n  </tr>\n  <tr>\n    <td>Nom de personne de l'équipe dirigeante</td>\n    <td>1</td>\n  </tr>\n  <tr>\n    <td>Activités de l'entité</td>\n    <td>1</td>\n  </tr>\n</table> <h3>Index des projets</h3> <table class=\"tg\">\n  <tr>\n    <th class=\"tg-0pky\">Champ</th>\n    <th class=\"tg-0pky\">Poids</th>\n  </tr>\n  <tr>\n    <td>Titre du projet</td>\n    <td>10</td>\n  </tr>\n  <tr>\n    <td>Identifiant</td>\n    <td>10</td>\n  </tr>\n  <tr>\n    <td>Acronyme du projet</td>\n    <td>8</td>\n  </tr>\n  <tr>\n    <td>Nom des personnes liées</td>\n    <td>5</td>\n  </tr>\n  <tr>\n    <td>Identifiants des personnes liées</td>\n    <td>5</td>\n  </tr>\n  <tr>\n    <td>Identifiant de l'appel à projet</td>\n    <td>5</td>\n  </tr>\n  <tr>\n    <td>Identifiant de programme</td>\n    <td>5</td>\n  </tr>\n  <tr>\n    <td>Description</td>\n    <td>3</td>\n  </tr>\n  <tr>\n    <td>Identifiant des productions liées</td>\n    <td>3</td>\n  </tr>\n  <tr>\n    <td>Nom des participants</td>\n    <td>2</td>\n  </tr>\n  <tr>\n    <td>Acronyme des participants</td>\n    <td>2</td>\n  </tr>\n  <tr>\n    <td>Domaine de recherche</td>\n    <td>2</td>\n  </tr>\n  <tr>\n    <td>Mot-clés</td>\n    <td>2</td>\n  </tr>\n  <tr>\n    <td>Badge</td>\n    <td>2</td>\n</tr>\n  <tr>\n    <td>Identifiant des participants</td>\n    <td>2</td>\n  </tr>\n  <tr>\n    <td>Titre de production liée</td>\n    <td>1</td>\n  </tr>\n  <tr>\n    <td>Résumé de production liée</td>\n    <td>1</td>\n  </tr>\n  <tr>\n    <td>Sous-titre de production liée</td>\n    <td>1</td>\n  </tr>\n  <tr>\n    <td>Appel à projet</td>\n    <td>1</td>\n  </tr>\n  <tr>\n    <td>Programme</td>\n    <td>1</td>\n  </tr>\n</table>\n\n <h3>Index des fiches auteurs</h3><table class=\"tg\">\n  <tr>\n    <th class=\"tg-0pky\">Champ</th>\n    <th class=\"tg-0pky\">Poids</th>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Nom de l'auteur</td>\n    <td class=\"tg-0pky\">10</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Identifiant principal</td>\n    <td class=\"tg-0pky\">5</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Identifiant de production</td>\n    <td class=\"tg-0pky\">5</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Autres identifiants</td>\n    <td class=\"tg-0pky\">5</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Identifiant de projet</td>\n    <td class=\"tg-0pky\">5</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Idref</td>\n    <td class=\"tg-0pky\">2</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Orcid</td>\n    <td class=\"tg-0pky\">2</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Code de domaine de recherche</td>\n    <td class=\"tg-0pky\">2</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Domaine de recherche</td>\n    <td class=\"tg-0pky\">2</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Nom d'affiliation liée</td>\n    <td class=\"tg-0pky\">2</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Acronyme d'affiliation liée</td>\n    <td class=\"tg-0pky\">2</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Identifiant d'affiliation</td>\n    <td class=\"tg-0pky\">2</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Mot-clé de production</td>\n    <td class=\"tg-0pky\">2</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Role</td>\n    <td class=\"tg-0pky\">2</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Badge</td>\n    <td class=\"tg-0pky\">2</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Prix scientifique</td>\n    <td class=\"tg-0pky\">2</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Titre de production</td>\n    <td class=\"tg-0pky\">1</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Sous-titre de production</td>\n    <td class=\"tg-0pky\">1</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Résumé de production</td>\n    <td class=\"tg-0pky\">1</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Titre de projet lié</td>\n    <td class=\"tg-0pky\">1</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0lax\">Acronyme de projet lié</td>\n    <td class=\"tg-0lax\">1</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0lax\">Description</td>\n    <td class=\"tg-0lax\">1</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0lax\">Url de liens associés</td>\n    <td class=\"tg-0lax\">1</td>\n  </tr>\n</table> <h3>Index des productions</h3> <table class=\"tg\">\n  <tr>\n    <th class=\"tg-0pky\">Champ</th>\n    <th class=\"tg-0pky\">Poids</th>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Titre</td>\n    <td class=\"tg-0pky\">10</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Identifiant</td>\n    <td class=\"tg-0pky\">10</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Sous-titre</td>\n    <td class=\"tg-0pky\">8</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Résumé</td>\n    <td class=\"tg-0pky\">8</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Nom d'auteur</td>\n    <td class=\"tg-0pky\">8</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Identifiant d'auteur</td>\n    <td class=\"tg-0pky\">8</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Identifiant d'affiliation</td>\n    <td class=\"tg-0pky\">8</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Nom d'affiliation</td>\n    <td class=\"tg-0pky\">5</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Nom de la revue</td>\n    <td class=\"tg-0pky\">5</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Titre de projet lié</td>\n    <td class=\"tg-0pky\">5</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Identifiant de projet lié</td>\n    <td class=\"tg-0pky\">5</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Autres identifiants</td>\n    <td class=\"tg-0pky\">5</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Mot-clé</td>\n    <td class=\"tg-0pky\">5</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Acronyme d'affiliation</td>\n    <td class=\"tg-0pky\">3</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Badge</td>\n    <td class=\"tg-0pky\">2</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Prix scientifique</td>\n    <td class=\"tg-0pky\">2</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Nom de l'éditeur</td>\n    <td class=\"tg-0pky\">1</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Nom de projet lié</td>\n    <td class=\"tg-0pky\">1</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Acronyme de projet lié</td>\n    <td class=\"tg-0pky\">1</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Domaine de recherche</td>\n    <td class=\"tg-0pky\">1</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0lax\">Code de domaine</td>\n    <td class=\"tg-0lax\">1</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0lax\">Url de liens</td>\n    <td class=\"tg-0lax\">1</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0lax\"></td>\n    <td class=\"tg-0lax\"></td>\n  </tr>\n</table>",
      en: "In response to a user's request, scanR provides an ordered list of results for each type of object. With identical data, this list is identical and independent of the number of times this request is played. It is also independent of users' actions based on the results of this query. This list is therefore not linked to users' actions. The list of results is ordered, by default, by relevance. It is thus the frequency of appearance of the query terms weighted by the type of document in which they appear that determines the order in which the results appear. Depending on the objects, the results can also be sorted by recency or alphabetically when relevant.\nThe fields (and their weighting) used to order the results of a query are specific to each type of scanR \"objects\" (entities, persons, projects, production). The following table shows, for each of them, their weighting method.<h3>Entities index </h3> <table class=\"tg\">\n  <tr>\n    <th class=\"tg-0pky\">Field</th>\n    <th class=\"tg-0pky\">Weights</th>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Acronym</td>\n    <td class=\"tg-0pky\">10</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Main id</td>\n    <td class=\"tg-0pky\">5</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Entity label</td>\n    <td class=\"tg-0pky\">5</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Related production identifier</td>\n    <td class=\"tg-0pky\">5</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Related project identifier</td>\n    <td class=\"tg-0pky\">5</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Mangement team person identifier</td>\n    <td class=\"tg-0pky\">5</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Other identifiers</td>\n    <td class=\"tg-0pky\">5</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Keywords</td>\n    <td class=\"tg-0pky\">3</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Alias</td>\n    <td class=\"tg-0pky\">2</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Badge</td>\n    <td class=\"tg-0pky\">2</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Description</td>\n    <td class=\"tg-0pky\">2</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Related project title</td>\n    <td class=\"tg-0pky\">1</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Related project description</td>\n    <td class=\"tg-0pky\">1</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Related project acronym</td>\n    <td class=\"tg-0pky\">1</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Affiliated author</td>\n    <td class=\"tg-0pky\">1</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Related production title</td>\n    <td class=\"tg-0pky\">1</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Related production sub-title</td>\n    <td class=\"tg-0pky\">1</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Related production summary</td>\n    <td class=\"tg-0pky\">1</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Website content</td>\n    <td class=\"tg-0pky\">1</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Management team person name</td>\n    <td class=\"tg-0pky\">1</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0lax\">Activities</td>\n    <td class=\"tg-0lax\">1</td>\n  </tr>\n</table> <h3>Projects index </h3> <table class=\"tg\">\n  <tr>\n    <th class=\"tg-0pky\">Field</th>\n    <th class=\"tg-0pky\">Weights</th>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Project title</td>\n    <td class=\"tg-0pky\">10</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Identifier</td>\n    <td class=\"tg-0pky\">10</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Project acronym</td>\n    <td class=\"tg-0pky\">8</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Related person name</td>\n    <td class=\"tg-0pky\">5</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Related person identifier</td>\n    <td class=\"tg-0pky\">5</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Project call identifier</td>\n    <td class=\"tg-0pky\">5</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Program identifier</td>\n    <td class=\"tg-0pky\">5</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Description</td>\n    <td class=\"tg-0pky\">3</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Related production identifier</td>\n    <td class=\"tg-0pky\">3</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Participant name</td>\n    <td class=\"tg-0pky\">2</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Participant acronym</td>\n    <td class=\"tg-0pky\">2</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Research domain</td>\n    <td class=\"tg-0pky\">2</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Keywords</td>\n    <td class=\"tg-0pky\">2</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Badge</td>\n    <td class=\"tg-0pky\">2</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Participant identifier</td>\n    <td class=\"tg-0pky\">2</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Related production title</td>\n    <td class=\"tg-0pky\">1</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Related production summary</td>\n    <td class=\"tg-0pky\">1</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Related production subtitle</td>\n    <td class=\"tg-0pky\">1</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Call for project</td>\n    <td class=\"tg-0pky\">1</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Program</td>\n    <td class=\"tg-0pky\">1</td>\n  </tr>\n</table><h3> Authors index </h3><table class=\"tg\">\n  <tr>\n    <th class=\"tg-0pky\">Field</th>\n    <th class=\"tg-0pky\">Weights</th>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Author name</td>\n    <td class=\"tg-0pky\">10</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Main identifier</td>\n    <td class=\"tg-0pky\">5</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Related production identifier</td>\n    <td class=\"tg-0pky\">5</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Other identifiers</td>\n    <td class=\"tg-0pky\">5</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Related project identifier</td>\n    <td class=\"tg-0pky\">5</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Idref</td>\n    <td class=\"tg-0pky\">2</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Orcid</td>\n    <td class=\"tg-0pky\">2</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Research domain code</td>\n    <td class=\"tg-0pky\">2</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Research domain</td>\n    <td class=\"tg-0pky\">2</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Related affiliation name</td>\n    <td class=\"tg-0pky\">2</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Related affiliation acronym</td>\n    <td class=\"tg-0pky\">2</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Related affiliation identifier</td>\n    <td class=\"tg-0pky\">2</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Related production keyword</td>\n    <td class=\"tg-0pky\">2</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Role</td>\n    <td class=\"tg-0pky\">2</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Badge</td>\n    <td class=\"tg-0pky\">2</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Award</td>\n    <td class=\"tg-0pky\">2</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Related production title</td>\n    <td class=\"tg-0pky\">1</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Related production subtitle</td>\n    <td class=\"tg-0pky\">1</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Related production summary</td>\n    <td class=\"tg-0pky\">1</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Related project title</td>\n    <td class=\"tg-0pky\">1</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0lax\">Related project acronym</td>\n    <td class=\"tg-0lax\">1</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0lax\">Description</td>\n    <td class=\"tg-0lax\">1</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0lax\">Associated url</td>\n    <td class=\"tg-0lax\">1</td>\n  </tr>\n</table> <h3>Productions index</h3> <table class=\"tg\">\n  <tr>\n    <th class=\"tg-0pky\">Field</th>\n    <th class=\"tg-0pky\">Weights</th>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Title</td>\n    <td class=\"tg-0pky\">10</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Identifier</td>\n    <td class=\"tg-0pky\">10</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Subtitle</td>\n    <td class=\"tg-0pky\">8</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Summary</td>\n    <td class=\"tg-0pky\">8</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Authors name</td>\n    <td class=\"tg-0pky\">8</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Authors identifier</td>\n    <td class=\"tg-0pky\">8</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Affiliation identifier</td>\n    <td class=\"tg-0pky\">8</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Affiliation name</td>\n    <td class=\"tg-0pky\">5</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Journal name</td>\n    <td class=\"tg-0pky\">5</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Related project title</td>\n    <td class=\"tg-0pky\">5</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Related project identifier</td>\n    <td class=\"tg-0pky\">5</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Other identifier</td>\n    <td class=\"tg-0pky\">5</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Keyword</td>\n    <td class=\"tg-0pky\">5</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Affiliation acronym</td>\n    <td class=\"tg-0pky\">3</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Badge</td>\n    <td class=\"tg-0pky\">2</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Award</td>\n    <td class=\"tg-0pky\">2</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Publisher</td>\n    <td class=\"tg-0pky\">1</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Related project title</td>\n    <td class=\"tg-0pky\">1</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Related project acronym</td>\n    <td class=\"tg-0pky\">1</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0pky\">Research domain</td>\n    <td class=\"tg-0pky\">1</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0lax\">Research domain code</td>\n    <td class=\"tg-0lax\">1</td>\n  </tr>\n  <tr>\n    <td class=\"tg-0lax\">Associated url</td>\n    <td class=\"tg-0lax\">1</td>\n  </tr>\n</table>"
    }
  },
  {
    key: "q13",
  ...
  },
  {
    ...
    definition: {
      fr: "Deux solutions pour contribuer à l'amélioration de scanR : \n- Vous avez identifié une erreur, une omission sur une fiche entité, auteur, production ou financement particulière ? Utilisez le bouton \"Contribuer\" pour nous contacter !\n- Des remarques générales sur scanR, des idées de sources à intégrer, de propositions d'évolutions de l'interface, des envies de partenriats et de collaboration avec l'équipe ? Rendez-vous à la rubrique <a href='/contact'>Contact</a>.",
      en: "Two solutions to contribute to the improvement of scanR: \n- Have you identified an error or omission on a particular entity, author, production or funding record? Use the \"Contribute\" button to contact us!\n- General remarks on scanR, ideas of sources to integrate, proposals for evolutions of the interface, desires of partnerships and collaboration with the team? Go to the <a href='/contact'>Contact</a> section."
    }
  },
  {
    key: "q18",
  ...
  },
  {
    ...
    definition: {
      fr: "En contradiction avec les termes de la loi n° 2016-1321 of 7 octobre 2016 Pour une République numérique, toutes les données sur les financements publics de la recherche sur appel à projet ne sont pas accessibles. scanR valorise et intègre toutes les données auxquelles il accède. Dans certains cas, l'information est accessible via des bases de données ou des API mises à disposition par le producteur de la donnée. Dans d'autres cas, scanR ne dispose que de l'information diffusée de manière ouverte sur le site web de l'institution en charge du financement.\nSi les résultats d'une agence de financement n'y figure pas c'est que scanR n'accède pas à ces données ou que, compte tenu de la qualité de l'information disponible, le coût de traitement de l'information accessible est trop élevé.",
      en: "In contradiction with the terms of Law n° 2016-1321 of 7 October 2016 Pour une République numérique, not all data on public funding of research on a call for projects are accessible. scanR values and integrates all the data it accesses. In some cases, the information is accessible via databases or APIs made available by the data producer. In other cases, scanR only has access to information that is openly disseminated on the website of the funding institution.\n If a funding agency's results are not included, it is because scanR does not access this data at all or, given the quality of the information available, the cost of processing is too high."
    }
  },
  {
    key: "q20",
  ...
  },
  {
    ...
    definition: {
      fr: "Vous avez reçu un prix ou une distinction pour vos travaux de recherche mais scanR ne mentionne pas cette récompense ? Signalez-le nous [lien rubrique contact] et aidez nous à convaincre l'institution qui vous l'a décerné de verser régulièrement la liste de ses lauréats à scanR !\nVotre entreprise, fondation, association, institution publique décerne des prix et distinctions à des acteurs de la recherche ? Vous souhaitez apparaître dans scanR pour renforcer la reconnaissance de votre action au côté de la recherche française ? Contactez-nous [lien rubrique contact]  !",
      en: "You have received a scientific prize but scanR does not mention this award? Please let us know[link to contact section] and help us convince the institution that awarded you to regularly send the list of its winners to scanR!\nDoes your company, foundation, association, public institution award prizes and distinctions to research actors? Would you like to appear in scanR to strengthen the recognition of your action alongside French research? Contact us[link contact section] !"
    }
  },
  {
    key: "q25",
  ...
  },
  {
    ...
    definition: {
      fr: "scanR ne comporte pas de fiche auteur à votre nom alors que vous publiez ? Communiquez-nous votre nom, votre Idref ainsi que la liste des DOI de vos travaux et nous ajouterons une fiche-auteur à votre nom ! Rendez-vous à la rubrique \"Contact\" [Lien rubrique contact] !",
      en: "scanR does not have an author record in your name while you are publishing? Tell us your name, your Idref and the list of DOIs of your work and we will add an author profile to your name! Go to the \"Contact\" section[Link to contact section] !"
    }
  },
  {
    key: "q29",
    ...
    definition: {
      fr: "Vous souhaitez ne plus figurer en tant qu'auteur dans scanR ? \n- Parce que scanR ne référence que trop peu de vos travaux ? Nous pouvons arranger cela ensemble. Contactez nous en copiant/collant l'adresse scanR de votre page à partir de votre navigateur, communiquez nous la liste des DOI de vos publications ou encore leur identifiant HAL ou la référence dans SUDOC ou dans theses.fr. Nous ferons le nécessaire. \n- Pour une toute autre raison, vous ne souhaitez plus faire apparaître votre profil auteur dans scanR. Dans ce cas, nous supprimerons votre profil. Vos travaux resteront cependant accessibles via une recherche mais ils ne seront plus associés à un profil auteur à votre nom.",
  ...
  },
  {
    ...
    definition: {
      fr: "Via différentes sources (iLab, universités et établissement d'enseignement supérieur et de recherche ou d'organismes, veille, ...), scanR identifie certaines entreprises créées par les personnels d'un laboratoire ou utilisant les connaissances et technologies qui y sont développées. Ce repérage n'est pas exhaustif et s'améliorera grâce à vos retours et signalements ! Contactez-nous [lien rubrique contact] !",
      en: "Via different sources (iLab, universities and higher education and research institutions or organizations, monitoring,...), scanR identifies certain companies created by laboratory staff or using the knowledge and technologies developed in a laboratory. This tracking is not exhaustive and will improve thanks to your feedback and reports! Contact us[link contact section] !"
    }
  },
  {
    key: "q31",
    ...
    definition: {
      fr: "scanR indexe plusieurs types de publications : les thèses présentes dans theses.fr et soutenues depuis 1990 ; les publications publiées depuis 2013 et dont au moins un auteur a une affiliation française (en utilisant les données du Baromètre de la Science Ouverte pour les publications avec un DOI et HAL pour les autres) ; enfin sont aussi indexées les monographies extraites du SUDOC, publiées depuis 2013 et ayant un éditeur scientifique ou universitaire.",
  ...
  },
  {
    ...
    definition: {
      fr: "scanR analyse toutes les publications avec un DOI publiées depuis 2013 et n'affiche que celles où une affiliation française est détectée à partir de la page web de la publication. Par ailleurs les publications issues de HAL avec une affiliation française et publiées après 2013 sont aussi indexées, ainsi que certaines monographie du SUDOC, toujours depuis 2013, en fonction de l'éditeur (éditeur scientifique ou universitaire). Il est donc possible que certains travaux ne soient pas moissonnés et indexés, s'ils sont absents de nos sources ou si nous n'avons pas repéré d'affiliation française. Contactez-nous et nous travaillerons ensemble pour intégrer les travaux manquants.",
  ...
  },
  {
    ...
    definition: {
      fr: "scanR peut référencer une publication mais être dans l'incapacité de la relier à un profil-auteur. Homonymies et absence de profil dans les référentiels constituent les principales causes de cette situation. \nSi vous avez un homonyme, communiquez nous votre identifiant idref et, si possible, la liste des DOI de vos travaux (ou encore leur identifiants Sudoc) et nous ferons le nécessaire.\nSi vous ne disposez pas d'un identifiant Idref, adressez-vous à votre correspondant \"Information scientifique\" en bibliothèque universitaire ou dans votre centre de documentation. Et pensez par la même occasion à créer votre identifiant-auteur international ORCID et à relier votre profil ORCID à votre nouvel identifiant Idref !",
  ...
  },
  {
    ...
    icon: "fas fa-question-circle",
    label: {
      fr: "Comment la section \"Equipe\" d'une fiche entité est alimentée dans scanR ?",
      en: "How is the \"Team\" section of an entity record populated in scanR?"
    },
    definition: {
      fr: "L'équipe de direction des structures de recherche est identifiée grâce au Répertoire national des structures de recherche. Pour alimenter la section \"Auteurs identifiés dans la structure depuis 2018\", scanR procède à une analyse des affiliations des auteurs mentionnées dans les productions qu'il couvre. Cette analyse permet d'associer un auteur, une affiliation et une année de publication. C'est cette information qui est utilisée pour identifier les auteurs qui ont au moins une fois au cours des deux dernières années été associés à cette entité via une production. Cette section ne donne donc aucune indication sur la taille et la composition de l'équipe de l'entité.",
      en: "The management team of research structures is identified through the National Directory of Research Structures (RNSR). To feed the \"Authors identified in the structure since 2018\" section, scanR carries out an analysis of the affiliations of the authors mentioned in the productions it covers.  This analysis makes it possible to associate an author, an affiliation and a year of publication. It is this information that is used to identify authors who, over the past two years, have been associated with this entity through production at least once. This section therefore gives no indication of the size and composition of the entity's team."
    }
  },
  {
    key: "q41",
    ...
    definition: {
      fr: "scanR procède à une analyse des affiliations des auteurs mentionnées dans les productions qu'il couvre. Cette analyse permet d'associer un auteur, une affiliation et une année de publication. L'exhaustivité du repérage dépend de la capacité de scanR à associer un texte libre figurant sur une production à une entité référencée dans scanR. Des erreurs sont possibles mais scanR peut les corriger. Contactez-nous !",
      en: "scanR carries out an analysis of the affiliations of the authors mentioned in the productions it covers. This analysis makes it possible to associate an author, an affiliation and a year of publication. The completeness of the tracking depends on scanR's ability to associate free text on a production with an entity referenced in scanR. Errors are possible but scanR can correct them. Contact us!"
    }
  },
  {
    key: "q42",
    ...
    definition: {
      fr: "L'information mobilisée dans scanR provient de multiples sources de qualité très hétérogène. Ces sources sont associées à des référentiels qui leur sont souvent propres. scanR met en oeuvre un ensemble de processus pour fédérer autour d'\"Objets\" précis (entités, projets, auteurs, production) un maximum d'informations relatives à l'activité de recherche et d'innovation et tisser des liens entre ces \"Objets\". Il est impossible de garantir l'exhaustivité et l'absolue qualité des repérages et associations d' \"Objets\" réalisés dans scanR. Mais scanR cherche constamment à s'améliorer. Alors, aidez-nous à l'améliorer, signalez-nous les erreurs manifestes, les \"bizareries\" et autres bugs !",
      en: "The information mobilized in scanR comes from multiple sources of very heterogeneous quality. These sources are often associated with their own repositories. scanR implements a set of processes to federate around specific \"Objects\" (entities, projects, persons, production) a maximum of information relating to the research and innovation activity and to establish links between these \"Objects\". It is impossible to guarantee the completeness and absolute quality of the tracking and associations of \"Objects\" made in scanR. But scanR is constantly looking to improve. So, help us improve it, report obvious errors, \"weird\" and other bugs!"
    }
  },
  {
    key: "q43",
    ...
    definition: {
      fr: "*Non*, scanR ne mobilise que des sources ouvertes. scanR ne rediffuse aucune information issue de bases de données commerciales. scanR n'utilise dans ses processus d'enrichissement et de nettoyage de l'information aucune information issue de bases de données commerciales.",
      en: "*No*, scanR only uses open sources. scanR does not redistribute any information from commercial databases. scanR does not use any information from commercial databases in its enrichment and cleaning processes."
    }
  },
  {
    key: "q44",
  ...
  },
  {
    ...
    definition: {
      fr: "Le périmètre des brevets dans scanR correspond à toutes les demandes de propriété industrielle rattachées aux familles simples comprenant au moins un dépôt de brevet avec déposant français et dont la date de premier dépôt est postérieure au 1er janvier 2010. Les dernières actualisations concernent les demandes publiées au 25/07/2019.",
  ...
  },
  {
    ...
    definition: {
      fr: "Le moteur de recherche indexe le contenu des différents objets de scanR. Ce contenu, suivant les sources et les objets peut-être en français ou en anglais. Il est donc recommandé, notamment pour les recherches liées à une thématique, d'effectuer une recherche bilingue. Cela peut se faire grâce à l'opérateur \"|\" (ou) (cf la question \"Comment affiner une recherche avec des opérateurs ?\"",
      en: "The search engine indexes the content of the different scanR objects. This content, depending on the sources and objects, may be in French or English. It is therefore recommended, particularly for research related to a theme, to conduct a bilingual research. This can be done using the operator \"|\" (or) (see the question \"How to refine a search with operators?\""
    }
  }
]