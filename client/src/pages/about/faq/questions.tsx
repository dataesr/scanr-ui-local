export const questions = [
  ...
  },
  {
    ...
    definition: {
      fr: "Les réseaux sont construits à partir des publications de recherche de scanR. <ul><li> <h3>Collecte des publications</h3> scanR recherche toutes les publications liées à une requête spécifique de l'utilisateur.</li> <li><h3>Agrégation des publications</h3> Les publications obtenues sont agrégées en fonction du modèle de réseau : <ul><li><b>Modèle 'Auteurs' </b><br></br> Les nœuds représentent les auteurs, et les arêtes indiquent le nombre de co-publications entre deux auteurs. </li> <li><b>Modèle 'Etablissements' </b><br></br> Les nœuds représentent les établissements, et les arêtes représentent le nombre de co-publications entre deux établissements. </li> <li><b>Modèle 'Laboratoires' </b><br></br>  Les nœuds représentent les laboratoires, et les arêtes indiquent le nombre de co-publications entre deux laboratoires. </li> <li><b>Modèle 'Thématiques' </b><br></br> Les nœuds représentent les thématiques, et les arêtes indiquent le nombre de co-publications entre deux thématiques. </li> <li><b>Modèle 'Logiciels' </b><br></br> Les nœuds représentent les logiciels, et les arêtes représentent le nombre de co-publications entre deux logiciels. </li></ul></li> <li><h3>Filtrage des données</h3>  Pour assurer la pertinence du réseau, scanR filtre les nœuds pour ne conserver que les plus pertinents, limitant un réseau aux 300 nœuds les plus importants et/ou aux 5 composantes principales au maximum. </li></ul>",
      en: "The networks are built from research publications from scanR. <ul><li> <h3>Collection of publications</h3> scanR searches for all publications related to a specific user query.</li> <li><h3>Aggregation of publications</h3> The obtained publications are aggregated according to the network model: <ul><li><b>'Authors' model</b><br></br> Nodes represent authors, and edges indicate the number of co-publications between two authors.</li> <li><b>'Institutions' model</b><br></br> Nodes represent institutions, and edges represent the number of co-publications between two institutions.</li> <li><b>'Structures' model</b><br></br> Nodes represent laboratories, and edges indicate the number of co-publications between two laboratories.</li> <li><b>'Themes' model</b><br></br> Nodes represent themes, and edges indicate the number of co-publications between two themes.</li> <li><b>'Software' model</b><br></br> Nodes represent software, and edges represent the number of co-publications between two software.</li></ul></li> <li><h3>Data Filtering</h3> To ensure the relevance of the network, scanR filters the nodes to keep only the most relevant ones, limiting a network to the top 300 most important nodes and/or up to 5 main components at maximum. </li></ul>",
    },
  },
  {
    key: "q59",
