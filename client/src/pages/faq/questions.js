const questions = [
  ...
  },
  {
    ...
    groupkey: "general",
    icon: "fas fa-question-circle",
    label: {.accordion.1.title: "Quelle est la nature du lien entre scanR et le Baromètre de la Science Ouverte ?",
      faq.q2.title: "What is the link between scanR and the Open Science Barometer?",
    },
    definition: {
  ...
  },
  {
    ...
    definition: {
      fr: "*Non*, scanR n'est pas exhaustif dans ses repérages. scanR peut comporter des erreurs et des omissions (voir FAQ \"Peut-il y avoir des erreurs dans scanR ?\") et ne traite que des sources ouvertes et réutilisables.",
      en: "*No*, scanR is not exhaustive in its tracking. scanR may contain errors and omissions (see FAQ \"Can there be errors in scanR?\") and only deals with open and reusable sources."
    }
  },
  {
    key: "q4",
